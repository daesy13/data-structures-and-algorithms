...
import static code401challenges.repeatedWord.RepeatedWord.repeatedWord;
import static org.junit.Assert.assertEquals;

public class RepeatedWordTest {
    @Test
    public void repeatedWordTest(){
    String input = "It was the best of times, it was the worst of times, it was the age of wisdom, it was the age of " +
    ...
    public void repeatedWordEdgeCase(){
        String input = "";
        String actual = repeatedWord(input);
        String expected = "Empty String, please try again";
        assertEquals(expected, actual);
    }
